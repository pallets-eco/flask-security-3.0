...
_default_messages = {
    ...
    'CONFIRM_REGISTRATION': (
        _('Thank you. Confirmation instructions have been sent to %%(email)s.'), 'success'),
    'EMAIL_CONFIRMED': (
    ...
    'PASSWORD_RESET_REQUEST': (
        _('Instructions to reset your password have been sent to %%(email)s.'), 'info'),
    'PASSWORD_RESET_EXPIRED': (
        _('You did not reset your password within %%(within)s. New instructions have been sent '
          'to %%(email)s.'), 'error'),
    ...
    'PASSWORD_RESET': (
        _('You successfully reset your password and you have been logged in automatically.'),
        'success'),
    'PASSWORD_IS_THE_SAME': (
        _('Your new password must be different than your previous password.'), 'error'),
    'PASSWORD_CHANGE': (
