...
_default_messages = {
    'UNAUTHORIZED': ('You do not have permission to view this resource.', 'security-error'),
    'CONFIRM_REGISTRATION': ('Thank you. Confirmation instructions have been sent to %(email)s.', 'security-success'),
    'EMAIL_CONFIRMED': ('Thank you. Your email has been confirmed.', 'security-success'),
    'ALREADY_CONFIRMED': ('Your email has already been confirmed.', 'security-info'),
    'INVALID_CONFIRMATION_TOKEN': ('Invalid confirmation token.', 'security-error'),
    'EMAIL_ALREADY_ASSOCIATED': ('%(email)s is already associated with an account.', 'security-error'),
    'PASSWORD_MISMATCH': ('Password does not match', 'security-error'),
    'RETYPE_PASSWORD_MISMATCH': ('Passwords do not match', 'security-error'),
    'INVALID_REDIRECT': ('Redirections outside the domain are forbidden', 'security-error'),
    'PASSWORD_RESET_REQUEST': ('Instructions to reset your password have been sent to %(email)s.', 'security-info'),
    'PASSWORD_RESET_EXPIRED': ('You did not reset your password within %(within)s. New instructions have been sent to %(email)s.', 'security-error'),
    'INVALID_RESET_PASSWORD_TOKEN': ('Invalid reset password token.', 'security-error'),
    'CONFIRMATION_REQUIRED': ('Email requires confirmation.', 'security-error'),
    'CONFIRMATION_REQUEST': ('Confirmation instructions have been sent to %(email)s.', 'security-info'),
    'CONFIRMATION_EXPIRED': ('You did not confirm your email within %(within)s. New instructions to confirm your email have been sent to %(email)s.', 'security-error'),
    'LOGIN_EXPIRED': ('You did not login within %(within)s. New instructions to login have been sent to %(email)s.', 'security-error'),
    'LOGIN_EMAIL_SENT': ('Instructions to login have been sent to %(email)s.', 'security-success'),
    'INVALID_LOGIN_TOKEN': ('Invalid login token.', 'security-error'),
    'DISABLED_ACCOUNT': ('Account is disabled.', 'security-error'),
    'EMAIL_NOT_PROVIDED': ('Email not provided', 'security-error'),
    'INVALID_EMAIL_ADDRESS': ('Invalid email address', 'security-error'),
    'PASSWORD_NOT_PROVIDED': ('Password not provided', 'security-error'),
    'USER_DOES_NOT_EXIST': ('Specified user does not exist', 'security-error'),
    'INVALID_PASSWORD': ('Invalid password', 'security-error'),
    'PASSWORDLESS_LOGIN_SUCCESSFUL': ('You have successfuly logged in.', 'security-success'),
    'PASSWORD_RESET': ('You successfully reset your password and you have been logged in automatically.', 'security-success'),
    'PASSWORD_CHANGE': ('You successfully changed your password.', 'security-success'),
    'LOGIN': ('Please log in to access this page.', 'security-info'),
    'REFRESH': ('Please reauthenticate to access this page.', 'security-info'),
}
